...
type CreateSphereType = (radius: number, position: Position) => void;
...
const createSphere: CreateSphereType = (radius, { x, y, z }) => {
  // Three.js Mesh
...
const createBox: CreateBoxType = (width, height, depth, { x, y, z }) => {
  // Three.js Mesh
